define(['jquery', 'plugs'], function () {
    ...
    $('body').on('click', '[data-load]', function () {
        ...
        var savePath = $(this).attr('data-save_path') || 'default';
        var ext = $(this).attr('data-ext') || '';
//        var url = window.APP_URL + '/plugs/upload-file-' + method + '.html?uptype=' + uptype + '&type=' + type + '&field=' + field;
        var url = window.APP_URL + '/plugs/show-' + method + '.html?uptype=' + uptype + '&type=' + type + '&field=' + field +'&save_path='+savePath+'&ext='+ext;
