define(function(require, exports, module){	
	...
	var md_CheckCode = function(p) {
		...
		this.getImgURL = p.getImgURL?p.getImgURL:"";
        this.checkImgURL = p.checkImgURL?p.checkImgURL:"";
		this.checkImgUrlDataType  = p.checkImgUrlDataType?p.checkImgUrlDataType:"jsonp";
		this.k = /^[\da-zA-Z]{4}$/,
		this.codeType = "IMG",
		this.h = {}
	};
	$.augment(md_CheckCode, {
		...
		_check: function(t) {
			...
			q.io = $.ajax({
				...
				dataType:q.checkImgUrlDataType||"jsonp",
				success: function(u) {
					q.checkingCode = "";
					if (u && u.status) {
						q.checkedCode = s;
	...
	var SuperCheckCode = function(e) {
		...
		this.checkImgUrlDataType  = e.checkImgUrlDataType?e.checkImgUrlDataType:"jsonp";
        ...
        this.checkcode = null;
        this.codeType = "";
		this.getImgURL = e.getImgURL?e.getImgURL:"";
        this.checkImgURL = e.checkImgURL?e.checkImgURL:"";
    };
    $.augment(SuperCheckCode, {
        ...
        init: function() {
            ...
            this.checkcode = md_CheckCode({
				...
				getImgURL:e.getImgURL,
				checkImgURL:e.checkImgURL,
				checkImgUrlDataType: e.checkImgUrlDataType
            }).init();
            this.validate(true);
