define(function(require, exports, module){	
    ...
    $.augment(md_Password, {
        ...
        checkStrength: function() {
            ...
            var k = h.level();
            if (k >= 6) {
                $(".pw-strength-icon").hide();
                $(".pw-strength-icon-3").css({"display":"inline-block"});
                j = 3
            } else {
                if (k > 2) {
                    $(".pw-strength-icon").hide();
                    $(".pw-strength-icon-2").css({"display":"inline-block"});
                    j = 2
                } else {
                    $(".pw-strength-icon").hide();
                    $(".pw-strength-icon-1").css({"display":"inline-block"});
                    j = 1
                }
            }
