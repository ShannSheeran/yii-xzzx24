...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(common\model\Configuration::getWechatConfig()->app_id);//公众账号ID
		$inputObj->SetMch_id(common\model\Configuration::getWechatConfig()->merchat_number);//商户号
...
//		$inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
	 ...
	 * 严重商户号
	 */
	public static function verification($appid = '',$mch_id = '')
	{
//	    if($appid != WxPayConfig::APPID){
//	        return false;
//	    }
	    if($appid != common\model\Configuration::getWechatConfig()->app_id){
	        return false;
	    }
	    
	    if($mch_id != common\model\Configuration::getWechatConfig()->merchat_number){
	        return false;
	    }
//	    if($mch_id != WxPayConfig::MCHID){
//	        return false;
//	    }
